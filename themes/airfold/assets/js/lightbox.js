...
(function() {
  ...
  function wrapContent(element) {
    // Skip if already wrapped or has no-lightbox class
    if (element.closest('.enlargeable') || element.classList.contains('no-lightbox')) {
      return;
    }
  ...
  function initHeaderControlPanel() {
    ...
    // Panel theme toggle (in control panel dropdown)
